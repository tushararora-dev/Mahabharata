...
def display_home(chapter_names):
    ...
    with col2:
        st.markdown(" ## Book 2 - Sabha Parva")
    with col3:
        st.markdown(
    ...
    with col2:
        st.markdown(" ## Book 3 - Vana Parva / Aranyaka Parva")
    with col3:
        st.markdown(
    ...
    with col2:
        st.markdown(" ## Book 4 - Virata Parva")
    with col3:
        st.markdown(
    ...
    with col2:
        st.markdown(" ## Book 5 - Udyoga Parva")
    with col3:
        st.markdown(
    ...
    with col2:
        st.markdown(" ## Book 6 - Bhishma Parva")
    with col3:
        st.markdown(
...
def main():
    # Page configuration
    st.set_page_config(page_title="Mahabharata", page_icon="🏹", layout="wide")
    ...
    *, body, html {{
    ...
    chapter_names = {
        ...
        5: "Udyoga Parva (The Book of Effort/Preparation)",
        ...
        10: "Sauptika Parva (The Book of the Sleepers)",
        ...
        15: "Ashramavasika Parva (The Book of Hermitage Life)",
